    ...
    >
      ...
      >
        <div className="space-y-10">
          ...
          <div>
            <h3 className="mb-3 text-lg font-semibold tracking-tight text-tint-ink">ChatImages</h3>
          ...
          <div>
            ...
            <p className="mb-3 max-w-2xl text-sm text-tint-muted">
              Controlled full-viewport viewer used by{' '}
              <code className="rounded bg-tint-surface px-1.5 py-0.5 text-[13px]">ChatImage</code> and{' '}
              <code className="rounded bg-tint-surface px-1.5 py-0.5 text-[13px]">ChatImages</code>. Hosts can
              mount it directly for custom galleries. Pattern ported from Bunny&apos;s feed lightbox.
            </p>
