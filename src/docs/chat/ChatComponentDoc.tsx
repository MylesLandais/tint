  ...
  return (
    ...
    >
      <DocsSection
        id="preview"
        title="Preview"
        description="Choose a scenario, send the suggested prompt, then stop, retry, approve, deny, pick a preferred response, attach a file, replay Maya’s cached clip, inspect the group-chat trace, or load earlier history."
      >
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="mb-6 max-w-2xl text-sm text-tint-muted">
              ...
              error parts take decision / retry callbacks.            </p>
          </div>
          <div>
          ...
          <div>
            <h3 className="mb-3 text-lg font-semibold">ChatFile</h3>            <PropsTable rows={filePartProps} />
          </div>
          <div>
