...
const IMPORT_SNIPPETS = {
  'components/code-editor': "import { CodeEditor } from '@nebula/tint/code-editor'",
  'components/release-chart': "import { ReleaseChart } from '@nebula/tint/release-chart'",
  'components/framebuffer': "import { Framebuffer } from '@nebula/tint/framebuffer'",
  'components/shell': "import { AppShell, NavRail, WorkspaceHeader } from '@nebula/tint/shell'",
  'components/media-player': "import { MediaPlayer } from '@nebula/tint/media-player'",
  'components/tile-map': "import { TileMapViewport } from '@nebula/tint/tile-map'",
  'components/annotation': "import { AnnotationCanvas } from '@nebula/tint/annotation'",
  'components/media-workspace': "import { MediaWorkspace } from '@nebula/tint/media-workspace'",
  'components/video-player': "import { VideoPlayer } from '@nebula/tint/video-player'",
  'components/media': "import { Slider, VolumeControl, Waveform } from '@nebula/tint/media'",
  'components/audio-input': "import { AudioInput } from '@nebula/tint/audio-input'",
  'components/settings-popout': "import { SettingsPopout } from '@nebula/tint/settings-popout'",
  'components/chat': "import { ChatConversation } from '@nebula/tint/chat'",
  'components/editor': "import { Editor } from '@nebula/tint/editor'",
  'components/code': "import { HighlightedCode, CodeTabs } from '@nebula/tint/code'",
  'components/terminal': "import { TerminalConsole } from '@nebula/tint/terminal'",
  'components/table': "import { DataTable } from '@nebula/tint/table'",
  'components/chrome': "import { Dialog, ProgressBar, Badge, ContextMenu, TreeView, ToastProvider } from '@nebula/tint'",
  'components/graph': "import { InteractiveGraphView } from '@nebula/tint/graph'",
  'components/socket': "import type { Socket, SocketSpec } from '@nebula/tint/socket'",
  'components/collab': "import { createCollabSession } from '@nebula/tint/collab'",
  'components/telemetry': "import { TraceViewer } from '@nebula/tint/telemetry'",
  'components/auth': "import { IdentifierSignInForm } from '@nebula/tint/auth'",
  'components/client-framework': "import { createTintClient, TintClientProvider } from '@nebula/tint/client'",
  'components/theme': "import { ThemePicker, ThemeToggle } from '@nebula/tint/theme'",
  'components/panel': "import { Panel } from '@nebula/tint/panel'",
  'components/button': "import { Button } from '@nebula/tint/button'",
  'components/icon': "import { Icon, StatusIcon } from '@nebula/tint/icon'",
  'components/dice': "import { DiceRoller } from '@nebula/tint/dice'",
  'components/form': "import { FormLayout, TextField, SelectField } from '@nebula/tint/form'",
  'components/character-card': "import { CharacterCardEditorForm } from '@nebula/tint/character-card'",
  'components/feed': "import { FeedLayout, ReaderPane, SplitPane } from '@nebula/tint/feed'",
  'components/activity': "import { ActivityFeed } from '@nebula/tint/activity'",
  'components/policy': "import { PolicyTable, PolicyEditor, PolicyDryRun } from '@nebula/tint/policy'",
  'components/notify': "import { NotificationBell, NotificationList } from '@nebula/tint/notify'",
  'components/board': "import { BoardLayout, BoardCard, BoardDetail } from '@nebula/tint/board'",
  'vault-tasks': "import { VAULT_TASK_BOARD } from './vaultTasks.generated'",
  'components/calendar': "import { CalendarMonthView, CalendarToolbar } from '@nebula/tint/calendar'",
  'components/scrolling-label': "import { ScrollingLabel } from '@nebula/tint/scrolling-label'",
  'graph': "import { InteractiveGraphView } from '@nebula/tint/graph'",
