  ...
  return (
    ...
    >
      <DocsSection id="preview" title="Preview">
        <DocsPreview className="flex flex-col gap-4">
          <Panel
            title="Notes"
            icon={<Icon icon={FileText} size="sm" />}
            expanded={open}
      ...
      >
        ...
        <div className="mt-4 rounded-xl border border-tint-warning/40 bg-tint-warning-soft p-4 text-sm leading-6 text-tint-warning-ink">
          <strong className="font-semibold">Watch the body’s display.</strong> Collapsing
          sets the <code>hidden</code> attribute, which only produces{' '}
