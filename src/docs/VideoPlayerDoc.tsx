    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <section id="preview" className="mb-14 scroll-mt-24">
          ...
          <div className="overflow-visible rounded-none border border-[var(--color-tint-border)] bg-[var(--color-tint-panel)] p-4 shadow-sm sm:p-6">
            <div className="overflow-visible rounded-none bg-[linear-gradient(160deg,#1a1d24_0%,#0f1115_100%)] p-3 sm:p-5">
              <VideoPlayer src={DEMO_SRC} />
            </div>
          </div>
        </section>
