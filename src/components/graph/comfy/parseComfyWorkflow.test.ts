...
// The LTX-2.3 workflow is demo content: it lives with the docs page that renders
// it, so a 5,017-line fixture is not part of the library or its published files.
import { loadComfyLtx23WithMockDiagnostics } from '../../../docs/graph/fixtures/comfy/loadComfyFixture'
import {
  configureComfyNode,
...
import { flattenValidationIssues } from '../contracts'
