    ...
    <AnimatePresence>
      {isOpen ? (
        <motion.div
          ...
          className={cn(
            'absolute right-0 bottom-[calc(100%+0.5rem)] z-30 w-72 overflow-hidden rounded-none border border-white/10 bg-[#14161ccc] text-white shadow-[0_16px_48px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:w-80',
            className,
          )}
        ...
        >
                    ...
                    {group.items.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            'flex w-full items-center gap-2 rounded-none px-2.5 py-2 text-left text-sm transition-colors',
                        ...
                        >
                          ...
                          {item.shortcut ? (
                            <kbd className="rounded-none bg-white/10 px-1.5 py-0.5 font-mono text-[11px] text-white/60">
                              {item.shortcut}
                            </kbd>
                          ) : null}
                          {isSelected ? (
          ...
          <div className="flex items-center justify-between gap-3 border-t border-white/10 px-3 py-2 text-[11px] text-white/45">
            {footer ?? (
              <>
                <span>
                  <kbd className="rounded-none bg-white/10 px-1 py-0.5">↑</kbd>{' '}
                  <kbd className="rounded-none bg-white/10 px-1 py-0.5">↓</kbd> navigate
                </span>
                <span>
                  <kbd className="rounded-none bg-white/10 px-1 py-0.5">↵</kbd> select
                  <span className="mx-2 text-white/25">·</span>
                  <kbd className="rounded-none bg-white/10 px-1 py-0.5">esc</kbd> close
                </span>
              </>
            )}
          </div>
